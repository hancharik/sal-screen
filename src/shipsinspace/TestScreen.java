...
public class TestScreen extends JFrame{
    ...
    public void createMainPanel(){
        ...
        sideButton1.addActionListener(new TestScreen.ControlButtonListener());
        sideButton2.addActionListener(new TestScreen.ControlButtonListener());
        sideButton3.addActionListener(new TestScreen.ControlButtonListener());
        sideButtonr1.addActionListener(new TestScreen.ControlButtonListener());
        sideButtonr2.addActionListener(new TestScreen.ControlButtonListener());
        sideButtonr3.addActionListener(new TestScreen.ControlButtonListener());
        bottomButton1.addActionListener(new TestScreen.ControlButtonListener());
        bottomButton2.addActionListener(new TestScreen.ControlButtonListener());
    ...
    public JPanel createGalaxyMap(){
        ...
        for(int i = 0; i < ShipsInSpace.size; i++){
                for(int j = 0; j < ShipsInSpace.size; j++){
                  ...
                  galaxyMapButton.addActionListener(new TestScreen.GalaxyMapButtonListener());
    ...
    public JPanel createSolarSystemMap(SolarSystem sSystem){
        ...
        for(int i = 0; i < ShipsInSpace.size; i++){
                for(int j = 0; j < ShipsInSpace.size; j++){
                  ...
                  solarSystemMapButton.addActionListener(new TestScreen.SolarSystemMapButtonListener());
